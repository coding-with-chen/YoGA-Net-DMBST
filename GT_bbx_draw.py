...
# 修改输入图片文件夹
img_folder = "C:/github_projects/AI/visual/yolov5/demo_image/tct_1514img/3"
img_list = os.listdir(img_folder)
img_list.sort()
# 修改输入标签文件夹
label_folder = "C:/github_projects/AI/visual/yolov5/demo_image/tct_1514lb/3"
label_list = os.listdir(label_folder)
label_list.sort()
# 输出图片文件夹位置
output_folder = 'C:/github_projects/AI/visual/yolov5/demo_image/tct_1514output/3'

labels = ['ascus', 'asch', 'lsil', 'hsil', 'scc', 'agc',\
         'trichomonas', 'candida', 'flora', 'herps', 'actinomyces']  # 这里修改为自己的类别

# 色盘，可根据类别添加新颜色，注意第一个别动，这是字体的颜色也就是白色，往后面推
colormap = [(255, 255, 255), (56, 56, 255), (151, 157, 255), (31, 112, 255), (129, 278, 55),\
            (56, 56, 255), (221, 160, 221), (130, 0, 75), (137, 249, 200), (130, 0, 175),\
            (50,205,250), (109,122,255), (92,92,255)]   # 不是RGB,是BGR
...
def xywh2xyxy(x, w1, h1, img):
    ...
    # 绘制矩形框
    cv2.rectangle(img, p1, p2, colormap[label_ind+1], thickness=8, lineType=cv2.LINE_AA)
